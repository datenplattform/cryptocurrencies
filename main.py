...
X_train, Y_train, X_test, Y_test, Y_daybefore, unnormalized_bases, window_size = load_data(
    "bitcoin-historical-data/bitstampUSD_1-min_data_2012-01-01_to_2018-01-08.csv", 50)
print(X_train.shape)
print(Y_train.shape)
print(X_test.shape)
print(Y_test.shape)
